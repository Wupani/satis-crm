    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Hedef Yönetimi</h1>
            <p className="text-gray-600 dark:text-gray-400">Personel satış hedeflerini belirleyin ve takip edin</p>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">Henüz hedef bulunmuyor</p>
          </div>
        ) : (
                  ...
                  <tr key={target.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{target.targetValue} Satış</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <Calendar className="w-4 h-4 text-gray-400 dark:text-gray-500 mr-2" />
                        <span className="text-sm text-gray-900 dark:text-gray-100">{target.period}</span>
                      </div>
                    </td>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg px-3 py-2 focus:ring-green-500 focus:border-green-500"
                  >
                  ...
                  {errors.userId && <p className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.userId}</p>}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    min="1"
                  />
                  {errors.targetValue && <p className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.targetValue}</p>}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg px-3 py-2 focus:ring-green-500 focus:border-green-500"
                  />
                  {errors.period && <p className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.period}</p>}
                </div>
